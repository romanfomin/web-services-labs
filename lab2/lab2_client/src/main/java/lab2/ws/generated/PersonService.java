 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://ws.lab2/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://ws.lab2/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://ws.lab2/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.lab2/", "PersonWebServicePort"), PersonWebService.class, features);
    }
